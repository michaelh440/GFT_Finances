...
<svelte:head>
  <title>{student ? `${student.first_name} ${student.last_name}` : 'Student Not Found'} | B&C Financial Tracker</title>
</svelte:head>
...
<div class="container">
  {#if !student}
    <div class="not-found">
      ...
      <a href="/hsi/students" class="btn-secondary">Back to Students</a>
    </div>
  {:else}
    <header>
      <div>
        <a href="/hsi/students" class="back-link">← Back to Students</a>
