<!-- src/routes/hsi/student_surveys/templates/new/+page.svelte -->
<script>
	...
	$: template_name = form?.values?.template_name ?? '';
		...
		<form method="POST" use:enhance>
			<div class="form-grid">
				<div class="form-group">
					...
					<input type="text" id="template_name" name="template_name" value={template_name} required placeholder="e.g. End of Session Survey" />
				</div>
				...
				<div class="form-group full-width">
					...
					<textarea id="description" name="description" rows="3" placeholder="Brief description of when this survey should be used">{description}</textarea>
				</div>
			</div>
