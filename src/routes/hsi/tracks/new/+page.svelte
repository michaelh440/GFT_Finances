<!-- src/routes/hsi/tracks/new/+page.svelte -->
<script>
...
<div class="container">
	<header>
		<div>
			<a href={resolve('/hsi/tracks')} class="breadcrumb">← Back to Tracks</a>
			<h1>Add New Track</h1>
		</div>
	</header>
		...
		<form method="POST" use:enhance>
			<div class="form-grid">
				<div class="form-group">
					...
					<input type="text" id="track_name" name="track_name" required class="input" />
				</div>
			...
			<div class="form-actions">
				...
				<a href={resolve('/hsi/tracks')} class="btn-secondary">Cancel</a>
			</div>
		</form>
	</div>
</div>
