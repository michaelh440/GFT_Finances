...
<div class="container">
	...
	{:else}
		<header>
			<div>
				<a href={resolve(`/hsi/classes/${classInfo.class_code}`)} class="back-link">← Back to {classInfo.class_name}</a>
				<h1>Edit Class</h1>
			</div>
		</header>
			...
			<form method="POST" use:enhance>
				<div class="form-grid">
					...
					<div class="form-group">
						...
						/>
						<span class="help-text">Event name as it appears in VBO CSV exports. Used for auto-matching during import.</span>
					</div>
...
<style>
	...
	.input-disabled { background-color: #f3f4f6; color: #6b7280; cursor: not-allowed; font-family: monospace; font-weight: 600; }
